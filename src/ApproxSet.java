//author: Martin Aumüller and Leah Peschel, ITU
...
public class ApproxSet {
    ...
    public byte[] addSet(ApproxSet A){
        for (int a = 0 ; a < m; a++){
            if (M[a] < A.getElementAtIndex(a)) M[a] = A.getElementAtIndex(a);
        }
        return M;
    }

    public byte getElementAtIndex (int index){ return this.M[index];}
